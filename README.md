...
| **20+ Languages** | TypeScript, JavaScript, ArkTS, Python, Go, Rust, Java, C#, VB.NET, PHP, Ruby, C, C++, CUDA, Objective-C, Metal, Swift, Kotlin, Scala, Dart, Lua, Luau, R, Nix, Robot Framework, Erlang, CFML, COBOL, Solidity, Terraform/OpenTofu, Svelte, Vue, Astro, Liquid, Pascal/Delphi |
...
| Robot Framework | `.robot`, `.resource` | Keywords, tests/tasks, variables, resource/Python/Libdoc calls, embedded arguments, setup/teardown/templates and static import resolution ([coverage and limitations](vendor/tree-sitter-robot/README.md)) |
