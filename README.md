...
| Robot Framework | `.robot`, `.resource` | Keywords, tests/tasks, variables, calls, setup/teardown/templates, and static resource import resolution ([coverage and limitations](vendor/tree-sitter-robot/README.md)) |
